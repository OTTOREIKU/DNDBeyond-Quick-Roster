// ==UserScript==
// @name         D&D Beyond Quick Roster with 5eTools
...
(function() {
    ...
    const openSheet = (id, type) => {
        ...
        let url;
        if (id === '5etools') {
            // Updated to user's GitHub Mirror
    ...
    // 5e Tools Logic (Back to Embedding for V30.0)
